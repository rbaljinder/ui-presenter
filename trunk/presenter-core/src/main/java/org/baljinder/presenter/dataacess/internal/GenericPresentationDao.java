...
public class GenericPresentationDao implements IPresentationDao, SupportsHibernate {
	...
	public Session getSession() {
		...
		return !getHibernateTemplate().isAllowCreate() ? SessionFactoryUtils.getSession(sessionFactory, false) : SessionFactoryUtils
				.getSession(sessionFactory, getHibernateTemplate().getEntityInterceptor(), getHibernateTemplate()
	...
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> getAllEntities(final List<Class<? extends Object>> modelList, final Integer maxResult,
			final Integer firstResult, final String queryString) {
			...
			public Object doInHibernate(Session session) throws HibernateException, SQLException {
				...
				for (Object object : response) {
					if (object instanceof Object[])
						result.add(handleMultiple((Object[]) object, modelList));
					else
	...
	private Map<String, Object> handleMultiple(Object[] pairs, List<Class<? extends Object>> modelList) {
